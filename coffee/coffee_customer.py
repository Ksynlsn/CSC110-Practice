...
print("Available varieties:", coffee_shop.bean_type)

# Get some inputs from the user
order_size = input("What size coffee do you want? ")
order_roast = input("What roast do you want? ")
order_beans = input("What beans do you want?")

# Send the order to the coffee shop module
shop_says = coffee_shop.order_coffee(order_size, order_roast, order_beans)
